...
class DirectionPreviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (directionData == null) {
      ...
      if (transportIndex == 1) {
        ...
        directions = [
          {"icon": Icons.north, "title": "Take bike route", "distance": "4 km"},
          {
            "icon": Icons.turn_right,
            "title": "Continue straight",
            "distance": "9 km",
      ...
      if (transportIndex == 3) {
        ...
        directions = [
          ...
          {"icon": Icons.turn_right, "title": "Cross road", "distance": "1 km"},
          {
            "icon": Icons.directions_walk,
            "title": "Continue straight",
            "distance": "4.5 km",
    ...
    return Column(
      children: [
        _direction(Icons.my_location, source, ""),
        ...
        _direction(Icons.location_on, destination, ""),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF137A1B),
  ...
  Widget _direction(IconData icon, String title, String distance) {
    return Padding(
